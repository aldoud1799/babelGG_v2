...
out = str(r['translation']).strip()
assert out.lower() != 'good game, well played', 'Test 4 failed — unchanged reply translation'
assert re.search(r'[\u3040-\u30FF\u4E00-\u9FFF]', out), 'Test 4 failed — expected Japanese script in reply translation'
